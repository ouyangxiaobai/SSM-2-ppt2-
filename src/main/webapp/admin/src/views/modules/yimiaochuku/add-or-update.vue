...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      obj.yimiaoshuliang = obj.yimiaoshuliang - this.ruleForm.yimiaoshuliang
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `yimiaochuku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yimiaochukuCrossAddOrUpdateFlag = false;
                  this.parent.search();

        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantupian.split(',')" :src="item" width="100" height="100">
                                      ...
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="接种好处" prop="jiezhonghaochu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="接种好处"
                  v-model="ruleForm.jiezhonghaochu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiezhonghaochu" label="接种好处" prop="jiezhonghaochu">
                    <span>{{ruleForm.jiezhonghaochu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="接种事项" prop="jiezhongshixiang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="接种事项"
                  v-model="ruleForm.jiezhongshixiang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiezhongshixiang" label="接种事项" prop="jiezhongshixiang">
                    <span>{{ruleForm.jiezhongshixiang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="关于疫苗" prop="guanyuyimiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="关于疫苗"
                  v-model="ruleForm.guanyuyimiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guanyuyimiao" label="关于疫苗" prop="guanyuyimiao">
                    <span>{{ruleForm.guanyuyimiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	biaoti : false,
	jiezhonghaochu : false,
	jiezhongshixiang : false,
	fabushijian : false,
	faburen : false,
	guanyuyimiao : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
            continue;
	            	            ...
	            	            if(o=='jiezhonghaochu'){
            this.ruleForm.jiezhonghaochu = obj[o];
	    this.ro.jiezhonghaochu = true;
            continue;
          }
	            	            if(o=='jiezhongshixiang'){
            this.ruleForm.jiezhongshixiang = obj[o];
	    this.ro.jiezhongshixiang = true;
            continue;
          }
	            	            if(o=='fabushijian'){
	    ...
	    this.ro.faburen = true;
            continue;
	            	            ...
	            	            if(o=='guanyuyimiao'){
            this.ruleForm.guanyuyimiao = obj[o];
	    this.ro.guanyuyimiao = true;
            continue;
          }
	            	            if(o=='fengmiantupian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yimiaozhishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yimiaozhishiCrossAddOrUpdateFlag = false;
                  this.parent.search();

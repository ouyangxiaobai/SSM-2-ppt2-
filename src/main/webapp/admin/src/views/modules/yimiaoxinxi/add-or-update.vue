          ...
          <el-form-item class="input" label="疫苗名称" prop="yimiaomingcheng">
              <el-input v-model="ruleForm.yimiaomingcheng" 
                placeholder="疫苗名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疫苗属性" prop="yimiaoshuxing">
          <el-input v-model="ruleForm.yimiaoshuxing" 
              placeholder="疫苗属性" clearable  :readonly="ro.yimiaoshuxing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="疫苗属性" prop="yimiaoshuxing">
              <el-input v-model="ruleForm.yimiaoshuxing" 
                placeholder="疫苗属性" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="疫苗数量" prop="yimiaoshuliang">
              <el-input v-model="ruleForm.yimiaoshuliang" 
                placeholder="疫苗数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="批准文号" prop="pizhunwenhao">
          <el-input v-model="ruleForm.pizhunwenhao" 
              placeholder="批准文号" clearable  :readonly="ro.pizhunwenhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="批准文号" prop="pizhunwenhao">
              <el-input v-model="ruleForm.pizhunwenhao" 
                placeholder="批准文号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
          <el-col :span="12">
              <el-form-item class="input" v-if="type!='info'"  label="适龄儿童年龄范围" prop="nianlingfw">
                  <el-input v-model="ruleForm.nianlingfw"
                            placeholder="适龄儿童年龄范围" clearable  :readonly="ro.nianlingfw"></el-input>
              </el-form-item>
              <div v-else>
                  <el-form-item class="input" label="适龄儿童年龄范围" prop="nianlingfw">
                      <el-input v-model="ruleForm.nianlingfw"
                                placeholder="适龄儿童年龄范围" readonly></el-input>
                  </el-form-item>
              </div>
          </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yimiaomingcheng = true;
            continue;
	            	            ...
	            	            if(o=='yimiaoshuxing'){
            this.ruleForm.yimiaoshuxing = obj[o];
	    this.ro.yimiaoshuxing = true;
            continue;
          }
	            	            if(o=='yimiaoshuliang'){
	    ...
	    this.ro.yimiaoshuliang = true;
            continue;
	            	            ...
	            	            if(o=='pizhunwenhao'){
            this.ruleForm.pizhunwenhao = obj[o];
	    this.ro.pizhunwenhao = true;
            continue;
          } if(o=='nianlingfw'){
            this.ruleForm.nianlingfw = obj[o];
	    this.ro.nianlingfw = true;
            continue;
          }
	            	            if(o=='youxiaoqi'){

      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="操作人" prop="caozuoren">
          <el-input v-model="ruleForm.caozuoren" 
              placeholder="操作人" clearable  :readonly="ro.caozuoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="操作人" prop="caozuoren">
              <el-input v-model="ruleForm.caozuoren" 
                placeholder="操作人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      obj.yimiaoshuliang = parseFloat(obj.yimiaoshuliang) + parseFloat(this.ruleForm.yimiaoshuliang)
      this.$http({
          url: `${table}/update`,
          method: "post",
          data: obj
        ...
        if (valid) {
          this.$http({
            url: `yimiaoruku/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yimiaorukuCrossAddOrUpdateFlag = false;
                  this.parent.search();
